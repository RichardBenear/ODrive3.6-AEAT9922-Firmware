...
public:
    ...
    alignas(4) uint8_t abs_spi_dma_tx_[4] = {0x00, 0x00, 0x00, 0x00}; //AEAT18 support
    alignas(4) uint8_t abs_spi_dma_rx_[4] = {0x00, 0x00, 0x00, 0x00}; //AEAT18 support

    size_t abs_spi_dma_length_ = 0; //AEAT18 support
